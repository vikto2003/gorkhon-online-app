...
const FAQ = ({ onClose }: FAQProps) => {
  ...
  const faqItems: FAQItem[] = [
    {
      question: "Что такое «НАШ чат»?",
      answer: "«НАШ чат» — это платформа для жителей посёлка Горхон. Здесь вы найдёте расписание транспорта, важные контакты служб, режим работы организаций, пункты выдачи заказов и сможете получить помощь через нашу ИИ-помощницу Лину.",
      icon: "Info"
    },
    {
    ...
    },
    {
      ...
      answer: "Все контакты служб находятся в разделе «Важные номера» на главной странице. Там указаны номера телефонов участкового, скорой, диспетчеров и других важных служб.",
      icon: "Phone"
    },
    {
      question: "Работает ли приложение без интернета?",
      answer: "Да! «НАШ чат» работает в режиме PWA (Progressive Web App). После первого открытия основная информация сохраняется и доступна офлайн. Вы сможете посмотреть расписание и контакты даже без интернета.",
      icon: "Wifi"
    },
    {
    ...
    },
    {
      ...
      answer: "Наши официальные страницы доступны в разделе «Настройки» → «Мы в соцсетях». Там вы найдёте ссылки на ВКонтакте, Telegram и MAX.",
      icon: "Share2"
    },
    {
      question: "Как сообщить об ошибке в приложении?",
      answer: "Напишите Лине в чате «позови специалиста» — она создаст обращение и передаст его в поддержку. Мы оперативно во всём разберёмся!",
      icon: "AlertCircle"
    },
    {
      question: "Могу ли я предложить улучшения для платформы?",
      answer: "Конечно! Мы открыты к вашим идеям. Напишите предложения Лине в чате или через раздел поддержки. Каждое мнение важно!",
      icon: "Lightbulb"
    },
    {
